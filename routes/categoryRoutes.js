...
import { createCategoryController, getAllCategoriesController, updateCategoryController, deleteCategoryController,getSingleCategoryController } from '../controllers/categoryController.js'
...
router.get('/:id', userAuthentication, authorize(["admin"]), getSingleCategoryController);
